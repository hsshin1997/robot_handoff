...
DEFAULT_PROJECT_PATH = PACKAGE_ROOT / "project.yaml"
DEFAULT_SOLVER_PATH = PACKAGE_ROOT / "solver_defaults.yaml"
DEFAULT_SCENE_CONFIG_PATH = PACKAGE_ROOT / "scene_config.yaml"
DEFAULT_PIPELINE_CONFIG_PATH = PACKAGE_ROOT / "pipeline_config.yaml"
