...
def audit_insertion(sim: WorkcellSim, planner: HandoffPlanner, direct, *,
                    contact_reader=None) -> dict:
    """Audit all selected insertion descents from scanner-side witnesses."""
    contact_reader = _contacts if contact_reader is None else contact_reader
...
def audit_reorientation(sim: WorkcellSim, planner: HandoffPlanner, plan, *,
                        contact_reader=None) -> dict:
