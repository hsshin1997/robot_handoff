...
artifact. This module calls
:func:`mujoco_sim.modeling.cad_preprocess.prepare_cad`, then
...
from .grasps import TriangleMesh
from ..core.paths import GENERATED_CAD_ROOT


DEFAULT_GENERATED_CAD = GENERATED_CAD_ROOT
